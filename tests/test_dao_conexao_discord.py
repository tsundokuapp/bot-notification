...
class TestConexaoDiscord:
    ...
    def test_postagem_capitulos_esta_funcionando(self):
        ...
        obra = Obra("Teste de Postagem Dados Adicionais", "https://tsundoku.com.br/wp-content/uploads/2022/02/Gosu_The_Master1.png","https://tsundoku.com.br/manga/liberte-aquela-bruxa/")
