...
RUN echo "0 12 * * * cd /home/project && /usr/local/bin/python3 /home/project/src/Main.py > /proc/1/fd/1 2>&1" >> /var/spool/cron/crontabs/root
RUN echo "0 16-22/2 * * * cd /home/project && /usr/local/bin/python3 /home/project/src/Main.py > /proc/1/fd/1 2>&1" >> /var/spool/cron/crontabs/root
